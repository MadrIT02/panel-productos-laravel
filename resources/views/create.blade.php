    ...
    <body class="bg-light min-vh-100 d-flex align-items-center justify-content-center py-4">
        <div class="card shadow-sm w-75 mx-4">
            <div class="card-body p-4">
                ...
                <form class="row g-4 needs-validation" novalidate method="POST" action="/productos">
                @csrf
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control" name="nombre" placeholder="Ej. Laptop Pro" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="number" class="form-control" step="0.01" name="precio" placeholder="0.00" required>
